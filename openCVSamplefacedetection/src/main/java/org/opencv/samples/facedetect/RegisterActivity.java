...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText Email, Password, Name ; //Text fields
    Button Register; //Button for register and submit form
    String NameHolder, EmailHolder, PasswordHolder;// Strings t ostore text from text fields
    Boolean EditTextEmptyHolder;// boolean variable to to store wheter a field is empty or not
    ...
    public void InsertDataIntoSQLiteDatabase(){
        ...
        } else { // This block will execute if any of the registration EditText is empty.
